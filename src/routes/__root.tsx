...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JK Service — Menuiserie aluminium à Kinshasa" },
      ...
      { name: "author", content: "JK Service" },
      { property: "og:title", content: "JK Service — Menuiserie aluminium à Kinshasa" },
      ...
      { name: "twitter:title", content: "JK Service — Menuiserie aluminium à Kinshasa" },
